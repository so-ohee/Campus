package com.ssafy.camping.utils;

public class Message {
    public static final String SIGNUP_SUCCESS = "회원가입 성공";
    public static final String SIGNUP_FAIL = "회원가입 실패";
    public static final String USER_WITHDRAWAL_SUCCESS ="회원 탈퇴 성공";
    public static final String USER_WITHDRAWAL_FAIL ="회원 탈퇴 실패";
    ...
    public static final String NOT_FOUND_CAMPSITE = "캠핑장이 존재하지 않습니다.";
    ...
    public static final String SAVE_BOOKMARK_SUCCESS = "북마크 저장 성공";
    public static final String DELETE_BOOKMARK_SUCCESS = "북마크 삭제 성공";
    public static final String BOOKMARK_FAIL = "북마크 실패";
