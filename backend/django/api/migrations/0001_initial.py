# Generated by Django 4.0.3 on 2022-03-23 04:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Survey',
            fields=[
                ('user_uid', models.OneToOneField(db_column='user_uid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='api.user')),
                ('induty', models.JSONField(blank=True, null=True)),
                ('lct_cl', models.JSONField(blank=True, null=True)),
                ('do_nm', models.CharField(blank=True, max_length=45, null=True)),
